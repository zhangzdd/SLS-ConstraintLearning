...
clear;clc;close all;
load("data\noisy_inversion_nominal_trajectory.mat");
%%
% For each noise level in transimission noise, plot the statistics for the
% resulting output noise via box plots

% x_error: 6x20 cell array, 6 noise levels, 20 data points per noise
% level

% transmission_noise_level 1x6 cell array, each entry stores a numerical noise
% level

% ---- Convert x_error cells to a numeric matrix [nLevels x nRuns] ----
[nLevels, nRuns] = size(x_error);
