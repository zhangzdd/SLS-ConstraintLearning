...
lambda_term = sdpvar(1,6);
lambda_init = sdpvar(1,6);
...
% Sanity checks
% constraints = [constraints, b_poly <= 2.99]; % This should give non-zero stationarity
% constraints = [constraints, b_poly >= 3.01]; % This should set the problem to be infeasible
